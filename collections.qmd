...
**A Collection usually contains a specific type of Source Records (either Group Source Record, Animal Source Records, Environmental Source Records, and Invertebrate Source Records)** Because multiple Collections can be part of an Event, then an Event can contain Source Records of multiple types.
