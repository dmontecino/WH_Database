...
environmental_source<-
  ...
  list(
    ...
    data.frame(
      ...
      Environmental Source Specimens included in the Surveillance Activity. For PCR protocols, it is strongly recommended to provide the forward primer sequence, the reverse
