...
Data Structure:
The following sections provide a detailed explanation of the data structure used in the WildHealthDat database. By understanding the structure, users can efficiently enter, navigate and manipulate the data stored within.

Data Dictionary:
The last section of this documentation contains a comprehensive data dictionary. The data dictionary serves as a valuable resource for users, as it provides a complete list and description of all the data elements present in the database. Each data element is defined, including its name, type, and any applicable constraints.
