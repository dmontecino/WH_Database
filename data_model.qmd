...
More complex relationships among the basic units in the data model, as well as other extra units in the data model are explained in the section "Complexities". We recommend first to learn more about the units from Project up to Diagnosis by continuing reading this documentation and checking the menu on the top right corner of this website and click on the corresponding unit ->.
