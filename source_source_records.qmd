...
**All Sources can potentially be identified and followed over time if needed**. Environmental and Arthropod Sources are associated with a specific site making it easy to track them over time; however, **Animal Sources and Group Sources might not be individually identified preventing following them over time in new Collections or an opportunistic finding**. 
