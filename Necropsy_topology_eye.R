...
eye_uris<-c("https://lod.nal.usda.gov/nalt/28392",
                   "https://lod.nal.usda.gov/nalt/38991",
                   "https://lod.nal.usda.gov/nalt/38989",
                   "https://lod.nal.usda.gov/nalt/28561",
                   "https://lod.nal.usda.gov/nalt/29206",
                   "https://lod.nal.usda.gov/nalt/38993",
                   "https://lod.nal.usda.gov/nalt/28564",
                   "https://lod.nal.usda.gov/nalt/38995",
                   "https://lod.nal.usda.gov/nalt/290574")
...
# Extract eye nodes
eye_nodes <- full_nalt_node[node_uri %in% eye_uris]
...
uri_nodes <- xml_attr(eye_nodes, "about")
...
preferred_labels <- extract_preferred_labels(eye_nodes)

# xml_find_all(eye_nodes, ".//skos:prefLabel")
...
create_eye_table <- function(labels, uris, definitions, alt_labels) {
