...
times in specific locations (e.g., the PREDICT Project or a minimum of a 
cross-sectional study with total n=2 collected during a single field visit 
in a single location, or rangers recording observations-only during their 
patrols).


If no new Field activities are added by the Project and the Surveillance Task(s)
