...
nose_uris<-c("https://lod.nal.usda.gov/nalt/54351",
            "https://lod.nal.usda.gov/nalt/54350",
            "https://lod.nal.usda.gov/nalt/308291",
            "https://lod.nal.usda.gov/nalt/53591")
...
# Extract eye nodes
nose_nodes <- full_nalt_node[node_uri %in% nose_uris]
...
uri_nodes <- xml_attr(nose_nodes, "about")
...
preferred_labels <- extract_preferred_labels(nose_nodes)
