...
body_cavities_uris<-c("https://lod.nal.usda.gov/nalt/1610",
                       "https://lod.nal.usda.gov/nalt/1609",
                       "https://lod.nal.usda.gov/nalt/18330",
                       "https://lod.nal.usda.gov/nalt/18328",
                       "https://lod.nal.usda.gov/nalt/51800")
...
body_cavities_nodes <- full_nalt_node[node_uri %in% body_cavities_uris]
...
uri_nodes <- xml_attr(body_cavities_nodes, "about")
...
preferred_labels <- extract_preferred_labels(body_cavities_nodes)
...
create_body_cavities_table <- function(labels, uris, definitions, alt_labels) {
...
# Create final table
body_cavities_table <- create_body_cavities_table(
  preferred_labels, 
  uri_nodes, 
  definitions, 
  alt_labels_list
