...
muscle_uris<-c("https://lod.nal.usda.gov/nalt/8976",
               "https://lod.nal.usda.gov/nalt/18497",
               "https://lod.nal.usda.gov/nalt/28570",
               "https://lod.nal.usda.gov/nalt/36135",
               "https://lod.nal.usda.gov/nalt/35050",
               "https://lod.nal.usda.gov/nalt/53793",
               "https://lod.nal.usda.gov/nalt/28572")
...
muscle_nodes <- full_nalt_node[node_uri %in% muscle_uris]
...
uri_nodes <- xml_attr(muscle_nodes, "about")
...
preferred_labels <- extract_preferred_labels(muscle_nodes)
...
create_muscle_table <- function(labels, uris, definitions, alt_labels) {
...
# Create final table
muscle_table <- create_muscle_table(
  preferred_labels, 
  uri_nodes, 
  definitions, 
  alt_labels_list
