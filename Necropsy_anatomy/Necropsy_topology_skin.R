...
skin_uris<-
  c("https://lod.nal.usda.gov/nalt/32499",
...
skin_nodes <- full_nalt_node[node_uri %in% skin_uris]
...
uri_nodes <- xml_attr(skin_nodes, "about")
...
preferred_labels <- extract_preferred_labels(skin_nodes)
...
create_skin_table <- function(labels, uris, definitions, alt_labels) {
