...
ears_uris<-c(
  "https://lod.nal.usda.gov/nalt/35074",
  "https://lod.nal.usda.gov/nalt/339897",
  "https://lod.nal.usda.gov/nalt/35107",
  "https://lod.nal.usda.gov/nalt/332330",
  "https://lod.nal.usda.gov/nalt/332326",
  "https://lod.nal.usda.gov/nalt/191711"
)
...
# Extract eye nodes
ear_nodes <- full_nalt_node[node_uri %in% ears_uris]
...
uri_nodes <- xml_attr(ear_nodes, "about")
...
preferred_labels <- extract_preferred_labels(ear_nodes)
...
create_ear_table <- function(labels, uris, definitions, alt_labels) {
