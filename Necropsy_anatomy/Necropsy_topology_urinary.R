...
urinary_uris<-c("https://lod.nal.usda.gov/nalt/17881", 
                  "https://lod.nal.usda.gov/nalt/17878",
                  "https://lod.nal.usda.gov/nalt/9343",
                  "https://lod.nal.usda.gov/nalt/66771",
                  "https://lod.nal.usda.gov/nalt/66772")
...
urinary_nodes <- full_nalt_node[node_uri %in% urinary_uris]
...
uri_nodes <- xml_attr(urinary_nodes, "about")
...
preferred_labels <- extract_preferred_labels(urinary_nodes)
...
create_urinary_table <- function(labels, uris, definitions, alt_labels) {
...
# Create final table
urinary_table <- create_urinary_table(
  preferred_labels, 
  uri_nodes, 
  definitions, 
  alt_labels_list
