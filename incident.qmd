...
The definition of a wildlife health event, and thus the concept of an 'Event', varies depending on the Surveillance Activity methodology. In active surveillance efforts, an Event may involve sampling healthy animals within a specific time and space to test them for a specific hazard. The inclusion of non-sampled individuals, as well as injured, sick, or dead animals, may or may not be considered part of the Event.

If samples are collected from a river, the 'Event' can be established at the point where the water is extracted. In the case of surveillance for vector-borne diseases, an Event  represents a specific point in time and space where one or several traps for vectors are deployed. In passive surveillance, an Incident could require the presence of at least one injured, sick, or dead animal, or a stranded individual. Additionally, healthy individuals found at the site can also be included as part of the 'Event'

In the case of beached fish, an Event can represent each individual dead fish at one extreme, or the total count of dead fish across the beach as a single point in time and space at the other extreme. However, neither of these strategies is ideal. The former is not suitable for logistical purposes, while the latter results in the loss of valuable information regarding the distribution of dead fish across the beach. 
...
events have types that define if the effort data is provided or not and at what level. They can have more than one. ... 

Finding: no effort (market, citizen science, tradepost)
Observation: for animal sources or grou sources
Capture: for Animal Sources or Group Source
Collection: for Environmetnal and Arthropod Sources. 

Events with different capture/collection divices aand differetn Source types can be linked together 
